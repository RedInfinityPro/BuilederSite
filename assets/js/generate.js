...
function editLink() {
    ...
    let type_input = document.getElementById("badge-type-input").value;
    let message_input = document.getElementById("badge-message-input").value;
    let mainColor_input = document.getElementById("badge-color-input").value.replace("#", "");
    let style_input = document.getElementById("badge-style").value;
